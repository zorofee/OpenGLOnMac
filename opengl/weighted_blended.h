...
int _main()
{
	...
	// -------------------------
	Shader solidShader("shaders/oit/solid.vs", "shaders/oit/solid.fs");
	Shader transparentShader("shaders/oit/transparent.vs", "shaders/oit/transparent.fs");
	Shader compositeShader("shaders/oit/composite.vs", "shaders/oit/composite.fs");
	Shader screenShader("shaders/oit/screen.vs", "shaders/oit/screen.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		compositeShader.use();
		compositeShader.setInt("accum", 0);
    	compositeShader.setInt("reveal", 1);
