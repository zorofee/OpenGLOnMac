...
int _main()
{
    ...
    // -------------------------
    Shader pbrShader("shaders/pbr/2.2.2.pbr.vs", "shaders/pbr/2.2.2.pbr.fs");
    ...
    Shader backgroundShader("shaders/pbr/2.2.2.background.vs", "shaders/pbr/2.2.2.background.fs");
